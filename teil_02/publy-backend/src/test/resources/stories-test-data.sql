...
VALUES (2, 1, '2021-11-02T20:07:37.917Z', 13,
        'D Story 2', '{"graphql","spring"}',
        'Body Story 2', 2);

INSERT INTO stories (id, version, created_at, written_by_id, title, tags, body_markdown, rc)
VALUES (3, 1, '2021-12-03T20:07:37.917Z', 10,
        'A Story 3', '{"spring"}',
        'Body Story 3', 1);

INSERT INTO stories (id, version, created_at, written_by_id, title, tags, body_markdown, rc)
VALUES (4, 1, '2022-01-04T20:07:37.917Z', 15,
        'I Story 4', '{"graphql","java"}',
        'Body Story 4', 3);

INSERT INTO stories (id, version, created_at, written_by_id, title, tags, body_markdown)
VALUES (5, 1, '2022-01-05T20:07:37.917Z', 12,
        'B Story 5', '{"graphl","c#"}',
        'Body Story 5');
